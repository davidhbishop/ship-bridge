...
class Client(object):
    ...
    def __zeroconf_server(self):
        ...
        import time
        from signalk.zeroconf import ServiceBrowser, Zeroconf
        ...
        list_of_service_keys = list(services.keys())
        service_info = services[list_of_service_keys[0]]
        service_info_server = service_info.server
        service_info_port = service_info.port

        return "%s:%s"%(service_info_server, service_info_port)
